...
def choose_file(): 
    ...
    while True: 
        print("\n" + "="*50)
        path = input("Введите путь до директории или файла (или 'q' для выхода): ").strip()
...
def choose(path):
    """Рекурсивная функция навигации по директориям"""
    ...
    if os.path.isdir(path):
        ...
        # Если нет ни файлов, ни директорий
        ...
        # Если есть и файлы, и директории
        if len(files_list) > 0 and len(dirs_list) > 0:
